...
mysql_connect("localhost","admin","admin");
	...
	{
		$path = "../../../ems_users/Male/".$user."/Profile/";
    	...
    	move_uploaded_file($img_tmp_name,"../../../ems_users/Male/".$user."/Profile/".$prod_img_path);
		
		mysql_query("insert into Profile_pic(EmailID,Image) values('$userid','$img_name')");
		header("location:../ems_step2/Secret_Question1.php");
	} 
?>
<html>
<head>
